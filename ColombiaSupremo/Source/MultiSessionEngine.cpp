...
MultiSessionEngine::MultiSessionEngine(const char *const modelFilePath,
                                 const size_t batchSize)
    : InferenceEngine(modelFilePath, batchSize) {}

void MultiSessionEngine::Run(const std::vector<TensorRawData> &inputs,
